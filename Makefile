...
clippy:
	...
	cargo clippy --workspace --all-features --exclude packit --exclude svsm-fuzz --exclude svsm --exclude kernel --exclude stage2 --exclude 'user*' --exclude stage1 --target=x86_64-unknown-linux-gnu -- -D warnings
