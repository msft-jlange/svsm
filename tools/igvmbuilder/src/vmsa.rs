...
pub fn construct_stage1_image(
    ...
    // Load the stage1 image.  It must not be larger than one page, and it must
    // be at least as large as the context..
    ...
    if stage1_image.len() < context_len {
        return Err("Stage1 image is too small".into());
    }
