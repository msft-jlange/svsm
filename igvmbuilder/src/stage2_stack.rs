...
use crate::igvm_builder::{SNP_COMPATIBILITY_MASK, TDX_COMPATIBILITY_MASK};
...
impl Stage2Stack {
    ...
    pub fn add_directive(
        ...
        let compatibility_mask = match platform {
            ...
            SvsmPlatformType::Tdx => TDX_COMPATIBILITY_MASK,
        };

        let mut stage2_stack = self.stage2_stack.clone();
